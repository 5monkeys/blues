...
from .application.tasks import setup, configure, deploy, deployed, start, stop,\
    reload, configure_providers, generate_env_file, generate_nginx_conf,\
    notify_deploy, install_requirements

from .application.deploy import update_source

__all__ = ['setup', 'configure', 'deploy', 'deployed', 'start', 'stop',
           'reload', 'configure_providers', 'generate_env_file',
           'generate_nginx_conf', 'install_requirements']
