...
from blues.application.providers.base import get_project_info, project_name
...
def configure():
    ...
    """
    with sudo(), silent():
        ctx = get_project_info() if project_name() else {}
        updates = blueprint.upload('./', '/etc', context=ctx)
